...
INSERT INTO BESTELLUNGZUTATEN(BESTELLUNGNR, ZUTATNR, MENGE) 
VALUES 
(1, 1001, 5),
(1, 1006, 2),
(1, 1002, 3),
...
INSERT INTO BESTELLUNGREZEPT(BESTELLUNGNR, REZEPTNR, MENGE) 
VALUES 
(1, 1, 5),
(6, 1, 1),
(8, 3, 1),
...
INSERT INTO REZEPTZUTAT (ZUTATNR, REZEPTNR, MENGE)
VALUES
(1013, 1, 1),  -- Paprika
(1003, 1, 5),   -- Tomate
(1004, 1, 1),   -- Schalotte
...
INSERT INTO REZEPTERNAEHRUNGSKATEGORIE (REZEPTNR, KATEGORIENR)
VALUES
    (1, 50),
    (2, 60),
    (3, 61),
